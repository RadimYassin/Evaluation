...
public class TestGestionStock {
    ...
    public static void main(String[] args) {
        try {
            ...
            Date date1 = sdf.parse("14/03/2018");
            Date date2 = sdf.parse("15/03/2018");
            Date date3 = sdf.parse("16/03/2018");

            Commande cmd1 = new Commande(date1, "radim yassine");
            Commande cmd2 = new Commande(date2, "mario palo");
            Commande cmd3 = new Commande(date3, "lio messi");
